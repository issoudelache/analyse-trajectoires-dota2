...
class GeometryUtils:
    ...
    @staticmethod
    def perpendicular_distances_vectorized(
        points: np.ndarray, line_start: np.ndarray, line_end: np.ndarray
    ) -> np.ndarray:
    ...
    def angular_distance(
        vector1: Union[np.ndarray, Tuple[float, float]],
        vector2: Union[np.ndarray, Tuple[float, float]],
    ) -> float:
